document.addEventListener("DOMContentLoaded", () => {
  ...
  submitBtn.addEventListener("click", async (e) => {
    ...
    const email = document
      .querySelector('input[placeholder="Email Adress"]')
      .value.trim();
    const flatNum = document
      .querySelector('input[placeholder="Flat Number"]')
      .value.trim();
    const contactNo = document
      .querySelector('input[placeholder="Contact Number"]')
      .value.trim();
